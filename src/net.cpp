...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"46.101.18.251", "46.101.18.251"},
    {"45.55.69.198", "45.55.69.198"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bacoin is probably already running."), addrBind.ToString().c_str());
        else
